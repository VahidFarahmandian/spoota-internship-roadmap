...
namespace UserManagement.API.Repository.Account
{
    public class UserAccount : IUserAccount
    {
        ...
        public async Task<GeneralResponse> CreateUserAccountAsync(RegisterDTO registerDTO)
        {
        ...
        public async Task<GeneralResponse> CreateAdminAccountAsync(RegisterDTO registerDTO)
        {
            if (registerDTO is null) return new GeneralResponse(false, "Model is Empty");
